...
└── ...
```
*Note: The scanner expects Year folders (e.g., `1890`, `1891-1892`) inside the specific profile folders (e.g., inside `images/jpg/`)*.
...
2.  **`path_parts`:** A tuple representing the folder path relative to the **Journal** folder.
    * *Example:* If your files are in `Journal/ocr/v3/`, the tuple is `('ocr', 'v3')`.
